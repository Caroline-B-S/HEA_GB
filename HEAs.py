...
def parK (alloys):
    """Tentativa 1 de implementação de K na tabela excel"""
...
def parStress (alloys):
    ...
    br=b.reshape((-1,1))
    p=(1+v)/(1-v)
    s=(alloys*dv**2/br**6).sum(axis=1)
    T0=0.051*alpha**(-0.3333)*G*p**(1.3333)*0.35*s**(0.6667)
